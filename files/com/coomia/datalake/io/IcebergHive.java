...
public class IcebergHive {
  ...
  public static void main(String[] args) {
    ...
    String createIcebergCatalog =
        "CREATE CATALOG iceberghive WITH ( 'type'='iceberg', 'catalog-type'='hive', 'uri'='thrift://itserver22:9083',  'clients'='5','property-version'='1', 'warehouse'='hdfs://itserver21:8020/warehouse')";
    tenv.executeSql(createIcebergCatalog);
    tenv.executeSql("show catalogs").print();
    tenv.useCatalog("iceberghive");
    tenv.executeSql("show tables").print();

    String table = "tb_iceberg" + System.currentTimeMillis();
    tenv.executeSql("CREATE TABLE " + table + " (\r\n" + "id BIGINT COMMENT 'unique id',\r\n"
        + "data STRING\r\n" + ")");
    tenv.executeSql("show tables").print();

    tenv.executeSql("INSERT INTO " + table + " VALUES (2, 'b')");
